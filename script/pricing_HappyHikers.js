...
// call updatePrice() when browser loads
...
function submitBooking() {
  alert(
    "Thank you for booking! An email will be sent for the payment instruction and other information for your trip. Have a joyful hike!"
  );
}
